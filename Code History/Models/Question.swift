...
//  Code History
//
//  Created by Esteban Calvete Iglesias on 23/3/22.
//

import Foundation

struct Question: Hashable { //Conforming to Hashable protocol we ensure we can use a Question type object as a key in a dictionary.
    ...
    static var allQuestions: [Question] = [
        ...
        Question(
            questionText: "What was the first coumputer bug?",
